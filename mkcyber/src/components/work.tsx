...
export default function Work(){
    return (
        ...
        {/* LEIDOS */}
            <TimelineItem>
                <TimelineOppositeContent sx={{color: 'gray'}}>
                    <Typography>Aug. 2024 - Present</Typography>
                ...
                <TimelineContent>
                    <Card variant="outlined">
                        ...
                        >
                            <Typography>Maritime Systems Division</Typography>
                        </Box>
                        
                        <List sx={{listStyleType: 'disc'}}>
                            <ListItem sx={{display: 'list-item', listStylePosition: 'inside', padding: 0}}>Working on a team to ensure cybersecurity for unmanned surface vessels (USVs)</ListItem>
                            <ListItem sx={{display: 'list-item', listStylePosition: 'inside', padding: 0}}>Modernized a legacy sensor component which is actively being used on water</ListItem>
            ...
            <TimelineItem>
                <TimelineOppositeContent sx={{color: 'gray'}}>
                    <Typography>Oct. 2023 - Jun. 2024</Typography>
                ...
                <TimelineContent>
                    <Card variant="outlined">
                        <CardContent>
                            ...
                            >
                            <Typography>Research under Dr. Yu Cai</Typography>
                            </Box>
            ...
            <TimelineItem>
                <TimelineOppositeContent sx={{color: 'gray'}}>
                    <Typography>Jun. 2023 - Aug. 2023</Typography>
                    <Typography>Fidelity Investments</Typography>
                </TimelineOppositeContent>
                <TimelineSeparator>
                    <TimelineDot color='primary'/>
                    <TimelineConnector/>
                ...
                <TimelineContent>
                    <Card variant="outlined">
                        <CardContent>
                            ...
                            >
                            <Typography>Fidelity Brokerage Technology (FBT)</Typography>
                            </Box>
                            <List sx={{listStyleType: 'disc'}}>
            ...
            <TimelineItem>
                <TimelineOppositeContent sx={{color: 'gray'}}>
                    <Typography>Nov. 2020 - Apr. 2022</Typography>
                    <Typography>Michigan Technological University</Typography>
                </TimelineOppositeContent>
                <TimelineSeparator>
                    <TimelineDot color='primary'/>
